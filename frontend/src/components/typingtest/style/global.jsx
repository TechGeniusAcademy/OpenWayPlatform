...
.stats-chart section .restart-button {
  position: fixed;
  top: 45px;
  right: 5px;
}
...
.restart-button .MuiGrid-container {
...
.restart-button .MuiGrid-container .MuiBox-root {
  display:flex !important;
  flex-direction: column !important;
  gap: 3px !important;
}

.restart-button .MuiGrid-container .MuiBox-root button {
